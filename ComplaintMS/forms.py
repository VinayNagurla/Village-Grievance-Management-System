...
class UserProfileform(forms.ModelForm):
    class Meta:
        model=Profile
        fields=('villagename','contactnumber','Ward')
...
class UserProfileUpdateform(forms.ModelForm):
    ...
    village =forms.CharField(widget = forms.TextInput(attrs={'readonly':'readonly'}))
    ward=forms.CharField(widget = forms.TextInput(attrs={'readonly':'readonly'}))
