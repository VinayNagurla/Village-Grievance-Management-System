...
DATABASES = {
    'default': {
        ...
        'NAME': 'webdata',  # Your MySQL database name
        'USER': 'root',  # Your MySQL username (often 'root' in XAMPP)
        'PASSWORD': '',  # Your MySQL password (leave empty if no password is set)
        'HOST': 'localhost',  # The MySQL server host (usually '127.0.0.1' or 'localhost')
        'PORT': '3306',  # The MySQL server port (usually '3306')
    }
}
